...
Dinosaur.create!(name: 'Brachiosaurus', image: 'https://vignette.wikia.nocookie.net/jurassicworld-evolution/images/b/ba/JWEBrachiosaurus.png/revision/latest/scale-to-width-down/310?cb=20200116002132');
Dinosaur.create!(name: 'Spinosaurus', image: 'https://vignette.wikia.nocookie.net/jurassicworld-evolution/images/b/b5/JWESpinosaurus.png/revision/latest/scale-to-width-down/310?cb=20190605203200');